...
Platillo.create(name: 'Pizza de Pepperoni', price: 11, category: 'Pizza')
Platillo.create(name: 'Pizza de Tocineta', price: 13, category: 'Pizza')
Platillo.create(name: 'Pizza de Hawainas', price: 14, category: 'Pizza')
Platillo.create(name: 'Pizza de Champiñones con Pollo', price: 15, category: 'Pizza')

Platillo.create(name: 'Jumbo Burger', price: 10, category: 'Hamburguesas')
Platillo.create(name: 'Burguer Mixta', price: 11, category: 'Hamburguesas')
Platillo.create(name: 'Burguer de Cerdo', price: 15, category: 'Hamburguesas')
Platillo.create(name: 'Burguer de Pollo crispy', price: 10, category: 'Hamburguesas')

Platillo.create(name: 'Servicio de Papas Fritas', price: 6, category: 'Papas')
Platillo.create(name: 'Servicio de Papitas delgadas', price: 4, category: 'Papas')

Platillo.create(name: 'Pasta a la carbonara', price: 12, category: 'Pastas')
Platillo.create(name: 'Pasta con Albondigas', price: 9, category: 'Pastas')
